require_dependency File.join(File.dirname(__FILE__), %w{.. .. vendor windowslivelogin})
require_dependency 'uri'
  ...
  class WindowsLive
    ...
    #
    def initialize()
      @wll = WindowsLiveLogin.new("000000004004141A", "iUDv2hbkAjUIPf1uPikFkjSmRPmqUbSM", "wsignin1.0", nil, "http://getvouched.com/privacy", "http://getvouched.com/contacts/import/Live")
    end
    ...
    def self.parse_xml(xml)
	 ...
	 new_contact = Hash["email", email, "name", name]
